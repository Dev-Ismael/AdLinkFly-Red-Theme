...
<style>
    ...
    .box-main div a.btn.btn-success{
        padding: 0 30px;
        line-height: 48px;
        border-radius: 24px;
        border: 2px solid #016d79!important;
