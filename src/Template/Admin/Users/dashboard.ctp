    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            <div class="inner">
                ...
                <h3>
                    <img src="../webroot/modern_theme/build/img/custom-icons/cardiogram.png" alt="">  
                    <?= display_price_currency($owner_earnings); ?>
                </h3>
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-aqua">
            <div class="inner">
                ...
                <h3>
                    <img src="../webroot/modern_theme/build/img/custom-icons/supermarket.png" alt="">  
                    <?= display_price_currency($publisher_earnings); ?>
                </h3>
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-green">
            <div class="inner">
                ...
                <h3>
                    <img src="../webroot/modern_theme/build/img/custom-icons/share.png" alt="">  
                    <?= display_price_currency($referral_earnings); ?>
                </h3>
