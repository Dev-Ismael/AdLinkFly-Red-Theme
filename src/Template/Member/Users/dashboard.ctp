        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-yellow">
                <div class="inner">
                    ...
                    <p><?= __('Total Views') ?></p>
                    <h3> <img src="../webroot/modern_theme/build/img/custom-icons/cardiogram.png" alt="">  <?= $total_views ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-aqua">
                <div class="inner">
                    ...
                    <h3>  <img src="../webroot/modern_theme/build/img/custom-icons/supermarket.png" alt="">  <span>  <?= display_price_currency($total_earnings); ?> </span> </h3>
            ...
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-green">
                    <div class="inner">
                        ...
                        <h3> <img src="../webroot/modern_theme/build/img/custom-icons/share.png" alt="">   <?= display_price_currency($referral_earnings); ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
                <div class="inner">
                    ...
                    <p><?= __('Average CPM') ?></p>
                    <h3>
                        <img src="../webroot/modern_theme/build/img/custom-icons/money2.png" alt="">  
